;;; tabbar ---  This are setting for nice tabbar items

;;; Commentary:
;;; See the following links for more info:
;;;   * http://stackoverflow.com/a/11918685
;;;    * https://code.google.com/p/my-emacs-config/source/browse/trunk/home/.emacs-config/settings/tabbar-settings.el?r=93
...
(defun my-tabbar-buffer-groups ()
 ...
 Emacs buffer are those starting with â€œ*â€."
   (list
    (cond
...
;;------------------------------------------------------------------------------
;;tabbarç¾ŽåŒ–ï¼Œå‚è€ƒè‡ªï¼šhttp://hi.baidu.com/fcl06/item/1043b9fefdbae65cc9f33782
;;------------------------------------------------------------------------------
...
(global-set-key (kbd "<lwindow> <up>") 'tabbar-backward-group)  ;; è¿™å‡ å¥çš„ç›®çš„æ˜¯ç»‘å®šå¿«æ·é”®è¿™æ ·å°±å¯ä»¥ç›´æŽ¥ç”¨å¿«æ·é”®æ¥æ“åšäº†ã€‚
(global-set-key (kbd "<lwindow> <down>") 'tabbar-forward-group) ;;ä¸è¿‡æ²¡æœ‰å‘çŽ°æœ‰å¾ˆå¤§ç”¨å¤„ï¼Œæ‰€ä»¥æ³¨é‡Šäº†ã€‚
